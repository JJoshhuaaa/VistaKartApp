...
<body>
    ...
    <section class="pricing-section">
        ...
        <div class="pricing-cards">
            <div class="card">
                <h2>2e plaats</h2>
                <img src="img/2nd.jpeg" loading="lazy" alt="Zilveren medaille">
            ...
            <div class="card">
                ...
                <img src="img/3d.jpg" loading="lazy" alt="Bronzen medaille">
    ...
    <div id="modal-1" class="modal">
        <div class="modal-content">
            ...
            <img src="img/cup.png" loading="lazy" alt="">
    ...
    <div id="modal-2" class="modal">
        <div class="modal-content">
            <img src="img/2nd.jpg" loading="lazy" alt="">
    ...
    <div id="modal-3" class="modal">
        <div class="modal-content">
            <img src="img/3.jpg" loading="lazy" alt="">
